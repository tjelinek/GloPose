...
from utils.eval_reconstruction import evaluate_reconstruction, update_dataset_reconstructions_stats
...
class Tracker6D:
    ...
    def run_pipeline(self):
        ...
        update_dataset_reconstructions_stats(rec_csv_detailed_stats, rec_csv_per_sequence_stats, num_keyframes, reconstruction,
