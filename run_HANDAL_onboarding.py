...
from utils.bop_challenge import (get_pinhole_params, load_gt_images_and_segmentations,
                                 read_obj2cam_Se3_from_gt)
...
def main():
    ...
    for sequence in sequences:
        ...
        dict_gt_Se3_obj2cam = read_obj2cam_Se3_from_gt(pose_json_path, config.device)
        obj_ids = sorted(dict_gt_Se3_obj2cam.keys())
        dict_gt_Se3_obj2cam = dict_gt_Se3_obj2cam[obj_ids[0]]
        gt_Se3_obj2cam_frame0 = dict_gt_Se3_obj2cam[0]
        ...
        run_tracking_on_sequence(config, write_folder, initial_gt_Se3_cam2obj=gt_Se3_obj2cam_frame0,
