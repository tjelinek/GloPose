...
def main():
    configurations = [
        ...
        # 'mft_iq/mft_iq_direct_8p_pose_direct',
        # 'mft_iq/mft_iq_flowformer_8p_pose',
        # 'mft_iq/mft_iq_flowformer_direct_8p_pose',
        # 'mft_iq/mft_iq_raft_8p_pose',
        # 'mft_iq/mft_iq_roma_8p_pose',
        # 'mft_iq/mft_iq_roma_direct_8p_pose',
        # 'mft_iq/mft_iq_synthetic_8p_pose',
        'mft_iq/mft_iq_synthetic_8p_pose_noise_sigma_1',
        'mft_iq/mft_iq_synthetic_8p_pose_noise_sigma_1_mu_01',
        'mft_iq/mft_iq_synthetic_8p_pose_noise_sigma_03',
        'mft_iq/mft_iq_synthetic_8p_pose_noise_sigma_03_mu_01',
        'mft_iq/mft_iq_synthetic_8p_pose_noise_sigma_005',
        'mft_iq/mft_iq_synthetic_8p_pose_noise_sigma_005_mu_01',
        # 'mft/mft_direct_8p_pose_direct',
        # 'mft/mft_raft_8p_pose',
        # 'mft/mft_roma_8p_pose',
        # 'mft/mft_roma_direct_8p_pose',
    ]
