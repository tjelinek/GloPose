...
def get_configurations():
    return [
        ...
        # --- P3.7: Segmentation point filtering ---
        'reconstruction/colmap_seg_filter',             # filter_points_by_segmentation=True
        # 'reconstruction/colmap_seg_filter_black_bg',

        # --- P3.8: Certainty threshold strategy: Otsu (default) vs fixed ---
        'onboarding/ufm_c0975r05_fixed_threshold',     # certainty_threshold_strategy='fixed'

        # --- P3.9: Matchability-guided reliability vs vanilla ---
        'onboarding/ufm_c0975r05_matchability',         # matchability_based_reliability=True

        # --- P3.10: Reliability method: certainty-based (default) vs RANSAC-based ---
        'onboarding/ufm_ransac_pycolmap',               # frame_filter='RANSAC', pycolmap essential matrix
        'onboarding/ufm_ransac_magsac',                 # frame_filter='RANSAC', MAGSAC++ fundamental matrix
    ]
